...
const SupportModalSimple: React.FC<SupportModalSimpleProps> = ({ isOpen, onClose }) => {
      ...
      <div className="bg-slate-900 rounded-2xl max-w-md w-full max-h-[90vh] overflow-hidden border border-slate-700">
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-700">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-xl font-bold text-white">Apoie o Projeto (Teste)</h3>
          </div>
          <button
            onClick={onClose}
